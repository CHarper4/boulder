...
export const UserContext = createContext({ user: null, username: null, photoURL: null, pomoSeconds: 3000, setPomoSeconds: null, breakSeconds: 600, setBreakSeconds: null, alert: true, setAlert: null });
